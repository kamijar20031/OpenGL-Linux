...
Rectangular::Rectangular(modelImporter *importer, glm::vec3 size, glm::vec3 position, glm::vec3 velocity, glm::vec3 color, bool isStatic) : GameObject("resources/models/cube/cube.obj", importer)
{
